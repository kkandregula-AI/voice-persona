...
const MODE_CONFIG: Record<VoiceMode, { label: string; color: string; icon: keyof typeof Ionicons.glyphMap }> = {
...
function HistoryItem({ entry, onDelete }: { entry: GeneratedEntry; onDelete: () => void }) {
  ...
  return (
    <Animated.View entering={FadeInDown} exiting={FadeOutLeft} style={styles.item}>
...
export default function HistoryScreen() {
  ...
  const filtered = filter ? history.filter((e) => e.mode === filter) : history;
            ...
            >
              <Text
                style={[
                  ...
                  { color: isSelected ? (conf?.color ?? Colors.accent) : Colors.textSecondary },
                ]}
              >
                {m ? conf!.label : "All"}
              </Text>
